...
- [x] Uses Hugo built-in templates: [Open Graph](https://gohugo.io/templates/internal#open-graph) and [Twitter Cards](https://gohugo.io/templates/internal#twitter-cards).
